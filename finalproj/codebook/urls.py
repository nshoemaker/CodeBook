...
urlpatterns = patterns('',
    ...
    url(r'^comment/repo/(?P<id>\d+)$', 'codebook.ajax_views.post_repo_comment', name='repo_comment'),
    url(r'^comment/file/(?P<id>\d+)$', 'codebook.ajax_views.post_file_comment', name='file_comment'),
    url(r'^star_repo/(?P<repo_id>\d+)$', 'codebook.ajax_views.star_repo', name='star_repo'),
    url(r'^unstar_repo/(?P<repo_id>\d+)$', 'codebook.ajax_views.unstar_repo', name='unstar_repo'),
    url(r'^watch_repo/(?P<repo_id>\d+)$', 'codebook.ajax_views.watch_repo', name='watch_repo'),
    url(r'^unwatch_repo/(?P<repo_id>\d+)$', 'codebook.ajax_views.unwatch_repo', name='unwatch_repo'),
)
